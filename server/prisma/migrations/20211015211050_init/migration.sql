...
CREATE TABLE `useraccount` (
    ...
    `initDate` TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP(0),
    `endDate` TIMESTAMP(0),
...
CREATE TABLE `userinfo` (
    ...
    `createdBy` CHAR(36) NOT NULL,
    `updatedBy` CHAR(36),
    `updatedAt` TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP(0),
...
-- AddForeignKey
ALTER TABLE `useraccount` ADD CONSTRAINT `useraccount_account_foreign` FOREIGN KEY (`account`) REFERENCES `account`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
